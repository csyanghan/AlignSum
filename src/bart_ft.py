...
# from bs_score import BERTScorer
...
os.environ["WANDB_PROJECT"] = "emnlp24" 

# 允许续训
# os.environ["WANDB_RESUME"] = "allow"
# os.environ["WANDB_RUN_ID"] = "suen3lql"
...
def main():
    ...
    # Wandb Resume https://github.com/huggingface/transformers/issues/25032
    ...
    def compute_metrics(eval_preds):
        ...
        # _, _, scores = scorer.score(decoded_preds, decoded_labels)
        # mean_score = torch.mean(scores).item()
        # result["bertscore"] = mean_score
